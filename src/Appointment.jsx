    ...
    <div>
      <header>
        <nav className="navbar">
          <div className="logo">
            <img src="logo.JPG" alt="Doctor Logo" className="doctor-logo" />
            <h1 className="text-white">DR. VIPIN TYAGI</h1>
          </div>
      ...
      <footer>
        <p className="text-white">&copy; Khatushyam Healthcare Services</p>
      </footer>
    </div>
  );
};
